---
name: contentflow-create
description: Create a finished ContentFlow video from a topic, title, idea, prompt, or script. This includes short-form, voice-over, educational, marketing, social-media, and stock-footage videos. Also use it when the user mentions MoneyPrinterTurbo, provides this Skill URL, asks an AI agent to install or configure MoneyPrinterTurbo, needs missing API keys identified, wants a failed generation repaired, or wants a generated MP4 located and delivered. Use this skill when the expected outcome is a final video file, not setup instructions.
...
metadata:
  ...
  version: "1.3.2"
  upstream: "https://github.com/adelrioj01/ContentFlow"
---

# ContentFlow Video Creation
...
```text
https://raw.githubusercontent.com/adelrioj01/ContentFlow/main/docs/skill/mpt_agent.py
```
